...
const translations = {
  en: {
    ...
    archiveLoadError: 'The archive could not be loaded.', oneObject: 'archived object', manyObjects: 'archived objects', memoryTitle: '',
  ...
  de: {
    ...
    archiveLoadError: 'Das Archiv konnte nicht geladen werden.', oneObject: 'archiviertes Objekt', manyObjects: 'archivierte Objekte', memoryTitle: '',
